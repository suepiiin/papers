...
for part1 in ('a', 'b'):
    for part2 in ('a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z'):
        if part1 == 'b' and part2 == 's':
            break
        os.system('wget ' + base_url + 'InterHand2.6M.images.5.fps.v1.0.tar.part' + part1 + part2)

os.system('wget ' + base_url + 'InterHand2.6M.images.5.fps.v1.0.tar.CHECKSUM')
os.system('wget ' + base_url + 'unzip.sh')
